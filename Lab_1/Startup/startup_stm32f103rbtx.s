...
turn_right:
	...
	itte	cc					// условие если "r8 < 9"
	addcc	r8, r8, #1			// то: "добавить к числу 1"
	andcc	r9, r9, #0x7F		// то: "выставить 8 бит (точку) в 0 (лог И по маске 0111_1111)
	orrcs	r9, r9, #0x80		// иначе: "выставить 8 бит (точку) в 1 (лог ИЛИ по маске 1000_0000)"
...
turn_left:
	...
	ite		hi					// условие если "r8 > 9"
	subhi	r8, r8, #1			// то: "добавить к числу 1"
	andcc	r9, r9, #0x7F		// то: "выставить 8 бит (точку) в 0 (лог И по маске 0111_1111)
	orrcs	r9, r9, #0x80		// иначе: "выставить 8 бит (точку) в 1 (лог ИЛИ по маске 1000_0000)"
