...
turn_right:
	...
	andlo	r9, r9, #0x7F		// то: "выставить 8 бит (точку) в 0 (лог И по маске 0111_1111)
	orrhs	r9, r9, #0x80		// иначе: "выставить 8 бит (точку) в 1 (лог ИЛИ по маске 1000_0000)"
...
turn_left:
	...
	andhi	r9, r9, #0x7F		// то: "выставить 8 бит (точку) в 0 (лог И по маске 0111_1111)
	orrls	r9, r9, #0x80		// иначе: "выставить 8 бит (точку) в 1 (лог ИЛИ по маске 1000_0000)"
