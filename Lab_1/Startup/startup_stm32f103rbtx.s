...
// инициализация порта С
    ...
    mov		r8, #5						// запись в регистр r8 начального значения для вывода на семисегментник
...
switch_digit:
	...
	tbb [PC, r8]			// поиск по таблице jump_table значения r7
...
set_segments:
    ...
    str r8, [r1]			// запись значений сегментов в регистр вывода
    bx lr
...
dt_changed:
	...
	b		turn_right			// то переход к повороту вправо
